<template>
  <el-main>
    ...
    >
      ...
      <el-table-column prop="parentName" label="所属部门" align="center"/>
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      if(this.hasPermission('sys:department:edit')){
        //数据回显
    ...
    async handleDelete(index, row) {
      if(this.hasPermission('sys:department:delete')) {
        //查询部门下是否存在子部门或用户
     ...
     */
    openAddWindow() {
      if(this.hasPermission('sys:department:add')){
        //清空表单数据
