<template>
  <el-container :style="{ height: containerHeight + 'px' }">
    ...
    <el-main>
          ...
          >
            ...
            <el-form-item label="头像">
              <el-upload
                ...
                :data="uploadHeader"
                action="http://localhost:8081/api/oss/file/upload?module=avatar"
              >
      ...
      <!-- 所属部门弹框 -->
      <system-dialog
        :title="parentDialog.title" :width="parentDialog.width"
      ...
      >
        <div slot="content">
          ...
          <el-pagination
            ...
            @current-change="assignCurrentChange" :current-page.sync="roleVo.pageNo"
      ...
      if (this.hasPermission('sys:user:delete')) {
        ...
        if (confirm) {
          ...
          if (res.success) {
            this.$message.success(res.message)
            //刷新
            await this.search(this.departmentId, this.pageNo, this.pageSize)
          } else {
            this.$message.error(res.message)
          }
        }
